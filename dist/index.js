...
const printUsage = () => {
    logger.info('Usage: tsx src/index.ts --url=https://example.com [--max-pages=40] [--same-origin-only=false] [--navigation-timeout=15000]');
};
const main = async () => {
